<?php
	...
	class SortController extends Zend_Controller_Action 
	{
		...
		function indexAction()
		{
			...
			//按页获取信息列表
			Page::create(array(
			"href_open" => "<a href='/info/sort?category={$categoryId}&p=%d'>", 
			"href_close" => "</a>", 
			...
			$this->view->rows = $Db->fetchAll('SELECT `entity_id`,`entity_title`,`entity_pub_time`,`entity_top`,`user_name`,`realName`,`entity_view_num` 
