	...
	class Zend_View_Helper_Editor
	{
		function editor($class_id, $width='100%', $height='300px')
		{
			return '<script type="text/javascript" src="/static/scripts/kind/KindEditor.js"></script>
					...
					editor.imageUploadCgi = "/static/scripts/kind/upload_cgi/upload.php?fpath='.$_SERVER['DOCUMENT_ROOT'].'/static/classes/'.$class_id.'/images/&ipath=/static/classes/'.$class_id.'/images/&size=100000";
