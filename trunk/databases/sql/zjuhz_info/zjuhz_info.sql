...
-- Records 
-- ----------------------------
INSERT INTO `tbl_category` VALUES ('1', 'radio', '浙大动态');
INSERT INTO `tbl_category` VALUES ('2', 'page_white_world', '各地校友动态');
INSERT INTO `tbl_category` VALUES ('9', 'anchor', '杭州校友会动态');
INSERT INTO `tbl_category` VALUES ('10', 'group', '校友互助信息');
INSERT INTO `tbl_category` VALUES ('11', 'rainbow', '校友企业展示');
INSERT INTO `tbl_category` VALUES ('12', 'talk', '校友访谈');
INSERT INTO `tbl_entity` VALUES ('4', '1', '浙大助小山村引来国家级科技项目', '1', '0', '1205305320', '0', '<div style=\\\"text-align: justify; text-indent: 2em;\\\"><font size=\\\"2\\\">今年初，地处浙西南山区的龙泉市安仁镇项边村，一个只有1400余总人口的小山村，成了国家科技部启动的首批120个新农村建设科技示范村（试点）之一。\r\n作为浙江大学龙泉市现代农业技术合作推广中心的村级服务点，依靠浙江大学的技术支撑，项边村引来了首个国家级科技项目。日前,该项目在当地正式启动. </font><font size=\\\"2\\\"><br></font><font size=\\\"2\\\"><br>&nbsp;&nbsp;&nbsp; 项边村是被称为“中国黑木耳第一乡”的安仁镇的中心村，该村70%的农户从事食用菌生产，60%的村民总收入也来自食用菌生产，异地种植黑木耳已达全国\r\n16个省（市），具有典型的“一村一品”的产业特色。2007年6月，浙江大学龙泉市现代农业技术合作推广中心成立，项边村被列为中心的村级服务点，由浙\r\n大教授担任首席专家引导该村食用菌产业的发展。目前，在浙大专家教授的指导下，当地农户成立了省内首个村级菌种研究所、省内首个黑木耳合作社，打下了良好\r\n的科技示范基础。 </font><font size=\\\"2\\\"><br></font><font size=\\\"2\\\"><br>&nbsp;&nbsp;&nbsp; 据介绍，“项边村新农村建设科技示范（试点）”项目将以浙江大学为主要技术依托单位，探索远郊山区食用菌产业循环发展的模式，为浙江西南山区乃至我国东南\r\n沿海欠发达山区的新农村建设提供示范。项目计划通过采用当地工业主导产业——木制玩具业的加工废弃物（木屑）、速生菇木林及经济林的修剪枝条等作为黑木耳\r\n生产原料，达到原料供给与生态保护的动态平衡。同时，开展废菌棒资源化多层次利用，生产生态有机肥、园艺基质及生物有机饲料，减少农业面源污染，实现生态\r\n食用菌（黑木耳）循环产业链。 </font><font size=\\\"2\\\"><br></font><font size=\\\"2\\\"><br></font><font size=\\\"2\\\">&nbsp;&nbsp;&nbsp; 新农村建设科技示范（试点）工作由国家科技部启动实施，旨在充分发挥科技在社会主义新农村建设中的示范导向作用，推动一批依靠科技创新建设社会主义新农村\r\n的示范，实现“富民、惠民”。示范（试点）以五年计划为周期，项目实施期限原则为2-3年。今年是第一批，共启动了73个新农村建设科技示范乡镇（试\r\n点）、120个新农村建设科技示范村（试点）。浙江省共有6个乡镇、村列入试点，以浙江大学为主要技术依托单位的有3个。另外两个是：绍兴市诸暨市山下湖\r\n镇和衢州市龙游县模环乡钱家村。</font></div>');
